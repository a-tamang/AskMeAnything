...
import com.ama.askmeanything.CompletedFragment.OnListFragmentInteractionListener;
import com.ama.askmeanything.ConvoContent.Convo;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link Convo} and makes a call to the
...
public class MyCompletedRecyclerViewAdapter extends RecyclerView.Adapter<MyCompletedRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCompletedRecyclerViewAdapter(List<Convo> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
